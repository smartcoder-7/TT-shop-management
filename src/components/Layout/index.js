        ...
        <footer className={styles.appFooter}>
          <div data-row>
            <ul data-col="12">
              ...
              <Link to="/shop">
                <li data-active={isRoot('/shop')}>
                  <span
                    className={styles.icon}
                    dangerouslySetInnerHTML={{ __html: shopSvg }}
                  />
                </li>
              </Link>
              <Link to="/now">
                <li data-active={isRoot('/now')}>
                  <span
                    className={styles.icon}
              ...
              <Link to="/account">
                <li data-active={isRoot('/account')}>
                  <span
                    className={styles.icon}
                    dangerouslySetInnerHTML={{ __html: accountSvg }}
                  />
                </li>
              </Link>
            </ul>
